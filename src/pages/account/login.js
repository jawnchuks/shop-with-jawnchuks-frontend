      ...
      >
        <section className="max-w-screen max-h-screen">
          ...
          >
            ...
            <label htmlFor="password" className="mt-5 mb-1 text-lg lg:text-xl">
              Password
            </label>
            <div
              className={
            ...
            <p className="text-right mb-8 text-lg lg:text-xl text-light-black font-medium">
              Forgot password?{" "}
              <a
                href="password-reset"
                className="text-black hover-underline-animation"
              >
                Reset it
              </a>{" "}
            </p>
            ...
            <p className="mt-4 text-center  text-lg lg:text-xl text-light-black font-medium ">
              ...
              <Link href="signup">
                <a className="text-black hover-underline-animation">Sign up</a>
              </Link>{" "}
            </p>
          </form>
        </section>
